^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
Changelog for package rom_diff_drive_controller
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
2.25.0 (2023-09-15)
-------------------
* removed duplicated previous_publish_timestamp\_ increment by publish_period\_ in rom_diff_drive_controller.cpp (`#644 <https://github.com/ros-controls/ros2_controllers/issues/644>`_) (`#777 <https://github.com/ros-controls/ros2_controllers/issues/777>`_)
...
2.18.0 (2023-04-29)
-------------------
* adjusted open_loop param description in rom_diff_drive_controller_parameter.yaml (`#570 <https://github.com/ros-controls/ros2_controllers/issues/570>`_) (`#576 <https://github.com/ros-controls/ros2_controllers/issues/576>`_)
...
2.5.0 (2022-05-13)
------------------
* [rom_diff_drive_controller] Made odom topic name relative as it was in ROS1. (`#343 <https://github.com/ros-controls/ros2_controllers/issues/343>`_)
* Fix wrong integration of velocity feedback in odometry in rom_diff_drive_controller (`#331 <https://github.com/ros-controls/ros2_controllers/issues/331>`_)
...
1.3.0 (2022-01-11)
------------------
* Add publish_rate option for the rom_diff_drive_controller (`#278 <https://github.com/ros-controls/ros2_controllers/issues/278>`_)
* Fix angular velocity direction of rom_diff_drive_controller odometry (`#281 <https://github.com/ros-controls/ros2_controllers/issues/281>`_)
* Contributors: Benjamin Hug, Paul Verhoeckx

1.2.0 (2021-12-29)
------------------
* Add velocity feedback option for rom_diff_drive_controller (`#260 <https://github.com/ros-controls/ros2_controllers/issues/260>`_)
...
* Fixes for Windows (`#205 <https://github.com/ros-controls/ros2_controllers/issues/205>`_)
  * Fix MSVC build for rom_diff_drive_controller test
...
* [rom_diff_drive_controller] Change header math.h in cmath for better C++ compliance (`#148 <https://github.com/ros-controls/ros2_controllers/issues/148>`_)
  and isnan inclusion.
