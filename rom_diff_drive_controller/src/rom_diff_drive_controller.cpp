...
#include "rom_diff_drive_controller/rom_diff_drive_controller.hpp"
...
namespace rom_diff_drive_controller
{
  ...
  const rclcpp::Time & time, const rclcpp::Duration & period)
{
  ...
  else
  {
    ...
    if (params_.position_feedback)
    {
      ...
      RCLCPP_INFO_STREAM(logger, "\033[1;33m" << "odom update by position feedback" << "\033[1;0m ");
    }
    else
    {
      ...
      RCLCPP_INFO_STREAM(logger, "\033[1;33m" << "odom update by velocity feedback" << "\033[1;0m ");
    }
  }
  ...
  */
  ...
  for (size_t index = 0; index < static_cast<size_t>(params_.wheels_per_side); ++index)
  {
    ...
    //RCLCPP_INFO_STREAM(logger, "\033[1;33m" << "Yellow " << "\033[1;0m "); // just test by PSA , IT'S OK
  }
...
CLASS_LOADER_REGISTER_CLASS(
  rom_diff_drive_controller::DiffDriveController, controller_interface::ControllerInterface)
